...
<div class="container">
    <div class="row">
        ...
        @endif
       <div class="col">
           <h3 class="mt-2">Change a Room</h3>
            <div class="card mt-3 mb-3">
                <div class="card-body">
                        <form action="/rooms/{{$room->number_room}}}" method="POST" enctype="multipart/form-data">
                            @method('patch')
                            @csrf
                            ...
                            <div class="form-group">
                                <label for="img-desc">{{$room->image_room}}</label><br>
                                <img src="/images/{{$room->image_room}}" alt="image room" width="200" height="200">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{('/rooms')}}" class="btn btn-success">Back</a>
                            </div>
                        </form>
                </div>
            </div>
