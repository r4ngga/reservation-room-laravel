                     ...
                     <div class="limit-box">
                        <nav class="main-menu">
                           <ul class="menu-area-main">
                              ...
                              <li class="mean-last"> <a href="#"><img src="/template_bootstrap/wise/images/search_icon.png" alt="#" /></a> </li>
                           </ul>
                        </nav>
                     </div>
                  </div>
         ...
         <div id="myCarousel" class="carousel slide banner-main" data-ride="carousel">
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <img class="first-slide" src="/template_bootstrap/wise/images/banner2.png" alt="First slide">
                  <div class="container">
               ...
               <div class="carousel-item">
                  <img class="second-slide" src="/template_bootstrap/wise/images/banner2.png" alt="Second slide">
                  <div class="container">
                     <div class="carousel-caption relative">
                        <h1>Basic template</h1>
                        <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and </p>
               ...
               <div class="carousel-item">
                  <img class="third-slide" src="/template_bootstrap/wise/images/banner2.png" alt="Third slide">
                  <div class="container">
                     <div class="carousel-caption relative">
                        <h1>Basic template</h1>
                        <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and </p>
            ...
            <div class="row">
               <div class="col-md-12">
                  <div id="main_slider" class="carousel slide banner-main" data-ride="carousel">
                     <div class="carousel-inner">
                        <div class="carousel-item active"> <img class="first-slide" src="/template_bootstrap/wise/images/banner.png" alt="First slide"> </div>
                        <div class="carousel-item"> <img class="second-slide" src="/template_bootstrap/wise/images/banner.png" alt="Second slide"> </div>
                        <div class="carousel-item"> <img class="third-slide" src="/template_bootstrap/wise/images/banner.png" alt="Third slide"> </div>
                     </div>
            ...
            <div class="row">
               <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                  <div id="testimonial_slider" class="carousel slide banner-bg" data-ride="carousel">
                     <div class="carousel-inner">
                        <div class="carousel-item active">
                           <img class="first-slide" src="/template_bootstrap/wise/images/testimonial-img.png">
                           <div class="container">
                        ...
                        <div class="carousel-item">
                           <img class="second-slide" src="/template_bootstrap/wise/images/testimonial-img.png">
                           <div class="container">
                              <div class="carousel-caption relat">
                                 <h3>Luka due</h3>
                                 <span><i class="fa fa-quote-left"></i> ( foundery )<i class="fa fa-quote-right"></i></span>
